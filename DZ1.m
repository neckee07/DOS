...
%jos prikazati cirkularnu konvoluciju kada ce biti jednaka sa linearnom
xpros=[x zeros(1,N)];
ypros=[y zeros(1,N)];
...
%% DRUGI ZADATAK
%dominantne komponente tamo gde je snaga najveca ima ih 3
%
